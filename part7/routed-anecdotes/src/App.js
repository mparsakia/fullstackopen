...
const Footer = () => (
  <div>
    Anecdote app footer for &nbsp;
    <a href="https://courses.helsinki.fi/fi/tkt21009">Full Stack Open</a>
    &nbsp;/&nbsp;
...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(`Your anecdote '${content.value}' has been added!`);
